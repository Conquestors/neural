...
module.exports = {
	...
	execute(message, args) {
        ...
        if(!message.member.hasPermission("MANAGE_NICKNAMES")) {
            ...
            message.channel.send(`You do not have permission to modify nicknames in this server.`)
        }
        ...
        if (message.content.length < 3) return message.reply('The provided nickname may not contain less than three characters.').then(sentMessage => {
        ...
        message.channel.send(`Successfully updated ${user}'s nickname to **${nickname}**.`)
