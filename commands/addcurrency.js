...
module.exports = {
    ...
    execute(message, args) {
        ...
        if(!user) return message.channel.send(`You are required to provide a user to add currency to.`)
          ...
          .setColor("#02ab00")
          .setDescription(`Successfully added ${args[1]} currency to ${user}'s balance.`);
